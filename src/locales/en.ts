export default {
  ...
  contact: {
    ...
    title: "Get In Touch",
    subtitle: "We're here to help your restaurant",
    info: {
      title: "Contact Information",
      description: "Get in touch with us through any of the channels below.",
      phone: "Phone",
      email: "Email",
      hours: "Business hours: Monday to Friday, 9am to 6pm",
    },
    form: {
      ...
      restaurantPlaceholder: "Your restaurant name",
      message: "Message",
      messagePlaceholder: "Tell us about your restaurant...",
      submit: "Send Message",
      submitting: "Sending...",
      success: "Message sent!",
      successDescription: "We'll get in touch soon.",
      error: "Form error",
    },
    validation: {
      ...
      restaurantTooLong: "Name too long",
  ...
  pricing: {
    ...
    features: {
      unlimitedMenus: "Unlimited digital menus",
      qrCodes: "QR codes for all tables",
      realTimeOrders: "Real-time order management",
      kitchenPanel: "Complete kitchen panel",
      reports: "Detailed reports and analytics",
      teamManagement: "Team and permissions management",
    ...
    footer: {
      allFeatures: "All features included. No hidden costs.",
      noCreditCard: "No credit card required",
      freeTrial: "14-day free trial",
    },
  },
