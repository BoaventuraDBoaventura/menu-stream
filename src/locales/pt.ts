export default {
  ...
  contact: {
    ...
    subtitle: "Estamos aqui para ajudar o seu restaurante",
    info: {
      title: "Informações de Contato",
      description: "Entre em contato conosco através de qualquer um dos canais abaixo.",
      phone: "Telefone",
      email: "Email",
      hours: "Horário de atendimento: Segunda a Sexta, 9h às 18h",
    },
    form: {
      ...
      restaurantPlaceholder: "Nome do seu restaurante",
      message: "Mensagem",
    ...
    validation: {
      ...
      emailTooLong: "Email muito longo",
      phoneRequired: "Telefone é obrigatório",
      phoneInvalid: "Telefone inválido",
      restaurantRequired: "Nome do restaurante é obrigatório",
      restaurantTooLong: "Nome muito longo",
  ...
  pricing: {
    ...
    plans: {
      ...
      growth: {
        ...
        price: "2.000",
        period: "MT/mês",
        restaurants: "3 Restaurantes",
        badge: "Popular",
      },
      professional: {
        name: "Profissional",
        description: "Para redes estabelecidas",
        price: "2.500",
        period: "MT/mês",
      ...
      enterprise: {
        ...
        price: "5.000",
        period: "MT/mês",
        restaurants: "Restaurantes Ilimitados",
      },
    },
    features: {
      unlimitedMenus: "Menus digitais ilimitados",
      qrCodes: "Códigos QR para todas as mesas",
      realTimeOrders: "Gestão de pedidos em tempo real",
      kitchenPanel: "Painel de cozinha completo",
      reports: "Relatórios e análises detalhadas",
      teamManagement: "Gestão de equipa e permissões",
    ...
    footer: {
      allFeatures: "Todas as funcionalidades incluídas. Sem custos escondidos.",
      noCreditCard: "Sem cartão de crédito",
      freeTrial: "14 dias de teste",
    },
  },
